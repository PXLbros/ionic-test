    ...
    <div class="main">
      ...
      <div class="main__venue">
        <div v-for="venue in venues" :key="venue.id" class="main__venue-card" :class="{ 'no-image': !hasImage(venue) }">
          ...
          <img v-if="hasImage(venue)" class="image" :src="venue.venueMainImage[0].url" alt="Venue Image">

          <div class="content">
            <div v-if="venue.venuePreheader" class="content__label">{{ venue.venuePreheader }}</div>
